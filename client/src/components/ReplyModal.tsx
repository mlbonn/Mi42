  ...
  return (
    <div className="fixed inset-0 bg-black bg-opacity-50 flex items-center justify-center z-50">
      <div className="bg-white rounded-lg p-6 max-w-4xl w-full max-h-[90vh] overflow-y-auto">
        ...
        <div className="mb-4 p-3 bg-gray-50 rounded border-l-4 border-[#E48F00]">
            ...
            <div className="p-4 bg-gray-50 rounded border border-gray-300">
              <div className="space-y-3">
                ...
                <button
                  ...
                  className="w-full px-4 py-2 bg-gray-700 text-white rounded hover:bg-gray-800 disabled:opacity-50"
                >
